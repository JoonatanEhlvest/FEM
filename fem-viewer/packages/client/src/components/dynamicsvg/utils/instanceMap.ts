import { BaseInstanceClass, InstanceClass, getBaseInstanceClass } from '@fem-viewer/types/InstanceClass';
 ...
 */
export const instanceClassMap: Record<BaseInstanceClass, InstanceDisplayProperties> = {
  'Process': {
    shape: {
      type: 'ellipse'
    },
 ...
 */
export const getInstanceDisplayProperties = (instanceClass: InstanceClass): InstanceDisplayProperties => {
